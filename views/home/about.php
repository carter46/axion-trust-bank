...
<section class="page-hero">
    <div class="container page-hero__content">
        ...
        <h1><?php echo htmlspecialchars($siteName . ' (' . $siteInitials . ')'); ?></h1>
...
<section class="section media-section">
    <div class="container media-layout media-layout--reverse">
        ...
        <div class="media-image">
            <img src="<?php echo SITE_URL . '/uploads/images/' . rawurlencode('businesswomen-going-work-together-city-while-talking-drinking-coffee copy.jpg'); ?>" alt="<?php echo htmlspecialchars($siteName . ' global presence'); ?>" loading="lazy" onerror="this.src='<?php echo SITE_URL . '/uploads/images/' . rawurlencode('co-working-people-working-together copy.jpg'); ?>'; this.onerror=null;">
        </div>
    </div>
</section>
...
<section class="section media-section">
    <div class="container media-layout">
        <div class="media-image">
            <img src="<?php echo SITE_URL . '/uploads/images/' . rawurlencode('man-woman-looking-clipboard copy.jpg'); ?>" alt="<?php echo htmlspecialchars($siteName . ' leadership'); ?>" loading="lazy" onerror="this.src='<?php echo SITE_URL . '/uploads/images/' . rawurlencode('co-working-people-working-together copy.jpg'); ?>'; this.onerror=null;">
        </div>
        <div class="media-content">
...
<section class="section media-section">
    <div class="container media-layout media-layout--reverse">
        ...
        <div class="media-image">
            <img src="<?php echo SITE_URL . '/uploads/images/' . rawurlencode('about-img-5.webp'); ?>" alt="<?php echo htmlspecialchars($siteName . ' innovation'); ?>" loading="lazy">
        </div>
    </div>
</section>
